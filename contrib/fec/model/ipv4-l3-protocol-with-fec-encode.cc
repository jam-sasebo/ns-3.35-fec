...
NS_LOG_COMPONENT_DEFINE ("Ipv4L3ProtocolwithFecEncode");

const uint16_t Ipv4L3ProtocolwithFecEncode::PROT_NUMBER = 0x0800;

NS_OBJECT_ENSURE_REGISTERED (Ipv4L3ProtocolwithFecEncode);

TypeId 
Ipv4L3ProtocolwithFecEncode::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::Ipv4L3ProtocolwithFecEncode")
    .SetParent<Ipv4> ()
    .SetGroupName ("Internet")
    .AddConstructor<Ipv4L3ProtocolwithFecEncode> ()
    .AddAttribute ("DefaultTtl",
                   "The TTL value set by default on "
                   "all outgoing packets generated on this node.",
                   UintegerValue (64),
                   MakeUintegerAccessor (&Ipv4L3ProtocolwithFecEncode::m_defaultTtl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FragmentExpirationTimeout",
                   "When this timeout expires, the fragments "
                   "will be cleared from the buffer.",
                   TimeValue (Seconds (30)),
                   MakeTimeAccessor (&Ipv4L3ProtocolwithFecEncode::m_fragmentExpirationTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("EnableDuplicatePacketDetection",
                   "Enable multicast duplicate packet detection based on RFC 6621",
                   BooleanValue (false),
                   MakeBooleanAccessor (&Ipv4L3ProtocolwithFecEncode::m_enableDpd),
                   MakeBooleanChecker ())
    .AddAttribute ("DuplicateExpire", "Expiration delay for duplicate cache entries",
                   TimeValue (MilliSeconds (1)),
                   MakeTimeAccessor (&Ipv4L3ProtocolwithFecEncode::m_expire),
                   MakeTimeChecker ())
    .AddAttribute ("PurgeExpiredPeriod", 
                   "Time between purges of expired duplicate packet entries, "
                   "0 means never purge",
                   TimeValue (Seconds (1)),
                   MakeTimeAccessor (&Ipv4L3ProtocolwithFecEncode::m_purge),
                   MakeTimeChecker (Seconds (0)))
    .AddTraceSource ("Tx",
                     "Send ipv4 packet to outgoing interface.",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecEncode::m_txTrace),
                     "ns3::Ipv4L3ProtocolwithFecEncode::TxRxTracedCallback")
    .AddTraceSource ("Rx",
                     "Receive ipv4 packet from incoming interface.",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecEncode::m_rxTrace),
                     "ns3::Ipv4L3ProtocolwithFecEncode::TxRxTracedCallback")
    .AddTraceSource ("Drop",
                     "Drop ipv4 packet",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecEncode::m_dropTrace),
                     "ns3::Ipv4L3ProtocolwithFecEncode::DropTracedCallback")
    .AddAttribute ("InterfaceList",
                   "The set of Ipv4 interfaces associated to this Ipv4 stack.",
                   ObjectVectorValue (),
                   MakeObjectVectorAccessor (&Ipv4L3ProtocolwithFecEncode::m_interfaces),
    ...
    .AddTraceSource ("SendOutgoing",
                     ...
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecEncode::m_sendOutgoingTrace),
                     "ns3::Ipv4L3ProtocolwithFecEncode::SentTracedCallback")
    .AddTraceSource ("UnicastForward",
                     "A unicast IPv4 packet was received by this node "
                     "and is being forwarded to another node",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecEncode::m_unicastForwardTrace),
                     "ns3::Ipv4L3ProtocolwithFecEncode::SentTracedCallback")
    .AddTraceSource ("MulticastForward",
                     "A multicast IPv4 packet was received by this node "
                     "and is being forwarded to another node",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecEncode::m_multicastForwardTrace),
                     "ns3::Ipv4L3ProtocolwithFecEncode::SentTracedCallback")
    .AddTraceSource ("LocalDeliver",
                     "An IPv4 packet was received by/for this node, "
                     "and it is being forward up the stack",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecEncode::m_localDeliverTrace),
                     "ns3::Ipv4L3ProtocolwithFecEncode::SentTracedCallback")
...
Ipv4L3ProtocolwithFecEncode::Ipv4L3ProtocolwithFecEncode()
  : m_fec(0)
{
...
void
Ipv4L3ProtocolwithFecEncode::Insert (Ptr<IpL4Protocol> protocol)
{
...
void
Ipv4L3ProtocolwithFecEncode::Insert (Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
...
void
Ipv4L3ProtocolwithFecEncode::Remove (Ptr<IpL4Protocol> protocol)
{
  NS_LOG_FUNCTION (this << protocol);
...
void
Ipv4L3ProtocolwithFecEncode::Remove (Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
  NS_LOG_FUNCTION (this << protocol << interfaceIndex);
...
Ptr<IpL4Protocol>
Ipv4L3ProtocolwithFecEncode::GetProtocol (int protocolNumber) const
{
...
Ptr<IpL4Protocol>
Ipv4L3ProtocolwithFecEncode::GetProtocol (int protocolNumber, int32_t interfaceIndex) const
{
...
void
Ipv4L3ProtocolwithFecEncode::SetNode (Ptr<Node> node)
{
...
Ptr<Socket> 
Ipv4L3ProtocolwithFecEncode::CreateRawSocket (void)
{
  NS_LOG_FUNCTION (this);
...
void 
Ipv4L3ProtocolwithFecEncode::DeleteRawSocket (Ptr<Socket> socket)
{
 ...
 */
void
Ipv4L3ProtocolwithFecEncode::NotifyNewAggregate ()
{
  NS_LOG_FUNCTION (this);
  if (m_node == 0)
    {
...
void 
Ipv4L3ProtocolwithFecEncode::SetRoutingProtocol (Ptr<Ipv4RoutingProtocol> routingProtocol)
{
...
Ipv4L3ProtocolwithFecEncode::GetRoutingProtocol (void) const
{
  NS_LOG_FUNCTION (this);
...
void 
Ipv4L3ProtocolwithFecEncode::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolwithFecEncode::SetupLoopback (void)
{
  NS_LOG_FUNCTION (this);
  ...
  node->RegisterProtocolHandler (MakeCallback (&Ipv4L3ProtocolwithFecEncode::Receive, this), 
                                 Ipv4L3ProtocolwithFecEncode::PROT_NUMBER, device);
  interface->SetUp ();
...
void 
Ipv4L3ProtocolwithFecEncode::SetDefaultTtl (uint8_t ttl)
{
...
uint32_t 
Ipv4L3ProtocolwithFecEncode::AddInterface (Ptr<NetDevice> device)
{
  ...
  tc->RegisterProtocolHandler (MakeCallback (&Ipv4L3ProtocolwithFecEncode::Receive, this),
                               Ipv4L3ProtocolwithFecEncode::PROT_NUMBER, device);
...
uint32_t 
Ipv4L3ProtocolwithFecEncode::AddIpv4Interface (Ptr<Ipv4Interface>interface)
{
...
Ptr<Ipv4Interface>
Ipv4L3ProtocolwithFecEncode::GetInterface (uint32_t index) const
{
...
uint32_t 
Ipv4L3ProtocolwithFecEncode::GetNInterfaces (void) const
{
  NS_LOG_FUNCTION (this);
...
int32_t 
Ipv4L3ProtocolwithFecEncode::GetInterfaceForAddress (
...
int32_t 
Ipv4L3ProtocolwithFecEncode::GetInterfaceForPrefix (
  Ipv4Address address, 
  Ipv4Mask mask) const
{
...
int32_t 
Ipv4L3ProtocolwithFecEncode::GetInterfaceForDevice (
...
bool
Ipv4L3ProtocolwithFecEncode::IsDestinationAddress (Ipv4Address address, uint32_t iif) const
{
...
void 
Ipv4L3ProtocolwithFecEncode::Receive ( Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol, const Address &from,
                          const Address &to, NetDevice::PacketType packetType)
{
  ...
  if (!m_routingProtocol->RouteInput (packet, ipHeader, device,
                                      MakeCallback (&Ipv4L3ProtocolwithFecEncode::IpForward, this),
                                      MakeCallback (&Ipv4L3ProtocolwithFecEncode::IpMulticastForward, this),
                                      MakeCallback (&Ipv4L3ProtocolwithFecEncode::LocalDeliver, this),
                                      MakeCallback (&Ipv4L3ProtocolwithFecEncode::RouteInputError, this)
                                      ))
    {
...
Ipv4L3ProtocolwithFecEncode::GetIcmp (void) const
{
  NS_LOG_FUNCTION (this);
...
bool
Ipv4L3ProtocolwithFecEncode::IsUnicast (Ipv4Address ad) const
{
...
bool
Ipv4L3ProtocolwithFecEncode::IsUnicast (Ipv4Address ad, Ipv4Mask interfaceMask) const
{
...
void 
Ipv4L3ProtocolwithFecEncode::SendWithHeader (Ptr<Packet> packet, 
                                Ipv4Header ipHeader,
                                Ptr<Ipv4Route> route)
{
...
void
Ipv4L3ProtocolwithFecEncode::CallTxTrace (const Ipv4Header & ipHeader, Ptr<Packet> packet,
...
void 
Ipv4L3ProtocolwithFecEncode::Send (Ptr<Packet> packet, 
                      Ipv4Address source,
                      ...
                      Ptr<Ipv4Route> route)
{
      ...
      if (!route->GetGateway ().IsInitialized ())
        {
          ...
          // to be queried).
          NS_FATAL_ERROR ("Ipv4L3ProtocolwithFecEncode::Send case 1a: packet passed with a route but the Gateway address is uninitialized. This case not yet implemented.");
        }

      // 1b) with a valid gateway
      NS_LOG_LOGIC ("Ipv4L3ProtocolwithFecEncode::Send case 1b:  passed in with route and valid gateway");
  ...
  if (destination.IsBroadcast () || destination.IsLocalMulticast ())
    {
      NS_LOG_LOGIC ("Ipv4L3ProtocolwithFecEncode::Send case 2:  limited broadcast - no route");
      ...
      for (uint32_t j = 0; j < GetNAddresses (ifaceIndex); j++)
        {
          ...
          if (destination.IsSubnetDirectedBroadcast (ifAddr.GetMask ()) && 
            ...
            {
              NS_LOG_LOGIC ("Ipv4L3ProtocolwithFecEncode::Send case 3:  subnet directed bcast to " << ifAddr.GetLocal () << " - no route");
              // create a proxy route for this interface
              Ptr<Ipv4Route> route = Create<Ipv4Route> ();
              route->SetDestination (destination);
              route->SetGateway (Ipv4Address::GetAny ());
  ...
  NS_LOG_LOGIC ("Ipv4L3ProtocolwithFecEncode::Send case 4:  not broadcast and passed in with no route " << destination);
  ...
  if (m_routingProtocol != 0)
    ...
    {
      NS_LOG_ERROR ("Ipv4L3ProtocolwithFecEncode::Send: m_routingProtocol == 0");
    }
  if (newRoute)
    {
      DecreaseIdentification (source, destination, protocol);
...
void
Ipv4L3ProtocolwithFecEncode::DecreaseIdentification (Ipv4Address source,
                                        Ipv4Address destination,
                                        uint8_t protocol)
{
...
Ipv4Header
Ipv4L3ProtocolwithFecEncode::BuildHeader (
  Ipv4Address source,
  Ipv4Address destination,
  uint8_t protocol,
...
void
Ipv4L3ProtocolwithFecEncode::SendRealOut (Ptr<Ipv4Route> route,
                             Ptr<Packet> packet,
  ...
  if (outInterface->IsUp ())
    {
      ...
      if ( packet->GetSize () + ipHeader.GetSerializedSize () > outInterface->GetDevice ()->GetMtu () )
      ...
      else
        {
          ...
          if (m_fec && m_fwin && init_)
            {
              RedundancyControl ();
              init_ = false;
            }

         if (packet->GetSize () > m_segmentSize)
           {   
             packet = m_fec->CreateDataPacket (packet, ipHeader); 
           }

          CallTxTrace (ipHeader, packet, m_node->GetObject<Ipv4> (), interface);
          outInterface->Send (packet, ipHeader, target);

          if (packet->GetSize () > m_segmentSize) fc_--; 

          while (fc_ == 0)
            {
             SendFecPacket (packet, ipHeader, outInterface);
             ic_--;
             if (ic_ == 0) RedundancyControl ();
            }
...
void
Ipv4L3ProtocolwithFecEncode::IpMulticastForward (Ptr<Ipv4MulticastRoute> mrtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
...
void
Ipv4L3ProtocolwithFecEncode::IpForward (Ptr<Ipv4Route> rtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
...
void
Ipv4L3ProtocolwithFecEncode::LocalDeliver (Ptr<const Packet> packet, Ipv4Header const&ip, uint32_t iif)
{
...
bool
Ipv4L3ProtocolwithFecEncode::AddAddress (uint32_t i, Ipv4InterfaceAddress address)
{
...
Ipv4L3ProtocolwithFecEncode::GetAddress (uint32_t interfaceIndex, uint32_t addressIndex) const
{
...
uint32_t 
Ipv4L3ProtocolwithFecEncode::GetNAddresses (uint32_t interface) const
{
  NS_LOG_FUNCTION (this << interface);
...
bool
Ipv4L3ProtocolwithFecEncode::RemoveAddress (uint32_t i, uint32_t addressIndex)
{
...
bool
Ipv4L3ProtocolwithFecEncode::RemoveAddress (uint32_t i, Ipv4Address address)
{
  NS_LOG_FUNCTION (this << i << address);
...
Ipv4Address
Ipv4L3ProtocolwithFecEncode::SourceAddressSelection (uint32_t interfaceIdx, Ipv4Address dest)
{
...
Ipv4Address 
Ipv4L3ProtocolwithFecEncode::SelectSourceAddress (Ptr<const NetDevice> device,
...
void 
Ipv4L3ProtocolwithFecEncode::SetMetric (uint32_t i, uint16_t metric)
{
...
uint16_t
Ipv4L3ProtocolwithFecEncode::GetMetric (uint32_t i) const
{
...
uint16_t 
Ipv4L3ProtocolwithFecEncode::GetMtu (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
bool 
Ipv4L3ProtocolwithFecEncode::IsUp (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolwithFecEncode::SetUp (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolwithFecEncode::SetDown (uint32_t ifaceIndex)
{
...
bool 
Ipv4L3ProtocolwithFecEncode::IsForwarding (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolwithFecEncode::SetForwarding (uint32_t i, bool val)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
Ptr<NetDevice>
Ipv4L3ProtocolwithFecEncode::GetNetDevice (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
...
void 
Ipv4L3ProtocolwithFecEncode::SetIpForward (bool forward) 
{
...
bool 
Ipv4L3ProtocolwithFecEncode::GetIpForward (void) const
{
  NS_LOG_FUNCTION (this);
  return m_ipForward;
}
...
void 
Ipv4L3ProtocolwithFecEncode::SetWeakEsModel (bool model)
{
...
bool 
Ipv4L3ProtocolwithFecEncode::GetWeakEsModel (void) const
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolwithFecEncode::RouteInputError (Ptr<const Packet> p, const Ipv4Header & ipHeader, Socket::SocketErrno sockErrno)
{
...
void
Ipv4L3ProtocolwithFecEncode::DoFragmentation (Ptr<Packet> packet, const Ipv4Header & ipv4Header, uint32_t outIfaceMtu, std::list<Ipv4PayloadHeaderPair>& listFragments)
{
...
bool
Ipv4L3ProtocolwithFecEncode::ProcessFragment (Ptr<Packet>& packet, Ipv4Header& ipHeader, uint32_t iif)
{
...
Ipv4L3ProtocolwithFecEncode::Fragments::Fragments ()
  : m_moreFragment (0)
{
  NS_LOG_FUNCTION (this);
}
...
void
Ipv4L3ProtocolwithFecEncode::Fragments::AddFragment (Ptr<Packet> fragment, uint16_t fragmentOffset, bool moreFragment)
{
...
bool
Ipv4L3ProtocolwithFecEncode::Fragments::IsEntire () const
{
  NS_LOG_FUNCTION (this);
...
Ptr<Packet>
Ipv4L3ProtocolwithFecEncode::Fragments::GetPacket () const
{
  NS_LOG_FUNCTION (this);
...
Ptr<Packet>
Ipv4L3ProtocolwithFecEncode::Fragments::GetPartialPacket () const
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolwithFecEncode::Fragments::SetTimeoutIter (FragmentsTimeoutsListI_t iter)
{
  m_timeoutIter = iter;
  return;
}

Ipv4L3ProtocolwithFecEncode::FragmentsTimeoutsListI_t
Ipv4L3ProtocolwithFecEncode::Fragments::GetTimeoutIter ()
{
...
void
Ipv4L3ProtocolwithFecEncode::HandleFragmentsTimeout (FragmentKey_t key, Ipv4Header & ipHeader, uint32_t iif)
{
...
bool
Ipv4L3ProtocolwithFecEncode::UpdateDuplicate (Ptr<const Packet> p, const Ipv4Header &header)
{
  ...
  if (!m_cleanDpd.IsRunning () && m_purge.IsStrictlyPositive ())
    {
      m_cleanDpd = Simulator::Schedule (m_expire, &Ipv4L3ProtocolwithFecEncode::RemoveDuplicates, this);
    }
...
void
Ipv4L3ProtocolwithFecEncode::RemoveDuplicates (void)
{
  NS_LOG_FUNCTION (this);
  ...
  if (!m_dups.empty () && m_purge.IsStrictlyPositive ())
    {
      m_cleanDpd = Simulator::Schedule (m_purge, &Ipv4L3ProtocolwithFecEncode::RemoveDuplicates, this);
    }
}

Ipv4L3ProtocolwithFecEncode::FragmentsTimeoutsListI_t
Ipv4L3ProtocolwithFecEncode::SetTimeout (FragmentKey_t key, Ipv4Header ipHeader, uint32_t iif)
{
  Time now = Simulator::Now () + m_fragmentExpirationTimeout;

  if (m_timeoutEventList.empty ())
    {
      m_timeoutEvent = Simulator::Schedule (m_fragmentExpirationTimeout, &Ipv4L3ProtocolwithFecEncode::HandleTimeout, this);
    }
  m_timeoutEventList.emplace_back (now, key, ipHeader, iif);

  Ipv4L3ProtocolwithFecEncode::FragmentsTimeoutsListI_t iter = --m_timeoutEventList.end();

  return (iter);
}

void
Ipv4L3ProtocolwithFecEncode::HandleTimeout (void)
{
  ...
  m_timeoutEvent = Simulator::Schedule (difference, &Ipv4L3ProtocolwithFecEncode::HandleTimeout, this);

  return;
}

void
Ipv4L3ProtocolwithFecEncode::SetFec (Ptr<FecRouterAgent> fec)
{
  NS_LOG_FUNCTION (this);
  m_fec = fec;

  m_fwin = m_fec->GetFwin ();
  m_nGroups = m_fec->GetNGroups ();
  m_segmentSize = m_fec->GetSegmentSize ();
}

void
Ipv4L3ProtocolwithFecEncode::RedundancyControl ()
{
  NS_LOG_FUNCTION (this);
  fc_ = m_fwin * m_nGroups;
  ic_ = m_nGroups;
  m_fec->UpdateFecTable ();
}

void
Ipv4L3ProtocolwithFecEncode::SendFecPacket (Ptr<Packet> packet, Ipv4Header const &ipHeader, Ptr<Ipv4Interface> outInterface)
{
  NS_LOG_FUNCTION (this);

  Ptr<Packet> p = m_fec->CreateFecPacket (packet, ipHeader);

  Ipv4Address target;
  target = ipHeader.GetDestination ();

  outInterface->Send (p, ipHeader, target); //when packet send, add ipheader at ipv4 Interface
}
