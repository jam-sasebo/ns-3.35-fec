...
NS_LOG_COMPONENT_DEFINE ("Ipv4L3ProtocolwithFecDecode");

const uint16_t Ipv4L3ProtocolwithFecDecode::PROT_NUMBER = 0x0800;

NS_OBJECT_ENSURE_REGISTERED (Ipv4L3ProtocolwithFecDecode);

TypeId 
Ipv4L3ProtocolwithFecDecode::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::Ipv4L3ProtocolwithFecDecode")
    .SetParent<Ipv4> ()
    .SetGroupName ("Internet")
    .AddConstructor<Ipv4L3ProtocolwithFecDecode> ()
    .AddAttribute ("DefaultTtl",
                   "The TTL value set by default on "
                   "all outgoing packets generated on this node.",
                   UintegerValue (64),
                   MakeUintegerAccessor (&Ipv4L3ProtocolwithFecDecode::m_defaultTtl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FragmentExpirationTimeout",
                   "When this timeout expires, the fragments "
                   "will be cleared from the buffer.",
                   TimeValue (Seconds (30)),
                   MakeTimeAccessor (&Ipv4L3ProtocolwithFecDecode::m_fragmentExpirationTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("EnableDuplicatePacketDetection",
                   "Enable multicast duplicate packet detection based on RFC 6621",
                   BooleanValue (false),
                   MakeBooleanAccessor (&Ipv4L3ProtocolwithFecDecode::m_enableDpd),
                   MakeBooleanChecker ())
    .AddAttribute ("DuplicateExpire", "Expiration delay for duplicate cache entries",
                   TimeValue (MilliSeconds (1)),
                   MakeTimeAccessor (&Ipv4L3ProtocolwithFecDecode::m_expire),
                   MakeTimeChecker ())
    .AddAttribute ("PurgeExpiredPeriod", 
                   "Time between purges of expired duplicate packet entries, "
                   "0 means never purge",
                   TimeValue (Seconds (1)),
                   MakeTimeAccessor (&Ipv4L3ProtocolwithFecDecode::m_purge),
                   MakeTimeChecker (Seconds (0)))
    .AddTraceSource ("Tx",
                     "Send ipv4 packet to outgoing interface.",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecDecode::m_txTrace),
                     "ns3::Ipv4L3ProtocolwithFecDecode::TxRxTracedCallback")
    .AddTraceSource ("Rx",
                     "Receive ipv4 packet from incoming interface.",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecDecode::m_rxTrace),
                     "ns3::Ipv4L3ProtocolwithFecDecode::TxRxTracedCallback")
    .AddTraceSource ("Drop",
                     "Drop ipv4 packet",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecDecode::m_dropTrace),
                     "ns3::Ipv4L3ProtocolwithFecDecode::DropTracedCallback")
    .AddAttribute ("InterfaceList",
                   "The set of Ipv4 interfaces associated to this Ipv4 stack.",
                   ObjectVectorValue (),
                   MakeObjectVectorAccessor (&Ipv4L3ProtocolwithFecDecode::m_interfaces),
    ...
    .AddTraceSource ("SendOutgoing",
                     ...
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecDecode::m_sendOutgoingTrace),
                     "ns3::Ipv4L3ProtocolwithFecDecode::SentTracedCallback")
    .AddTraceSource ("UnicastForward",
                     "A unicast IPv4 packet was received by this node "
                     "and is being forwarded to another node",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecDecode::m_unicastForwardTrace),
                     "ns3::Ipv4L3ProtocolwithFecDecode::SentTracedCallback")
    .AddTraceSource ("MulticastForward",
                     "A multicast IPv4 packet was received by this node "
                     "and is being forwarded to another node",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecDecode::m_multicastForwardTrace),
                     "ns3::Ipv4L3ProtocolwithFecDecode::SentTracedCallback")
    .AddTraceSource ("LocalDeliver",
                     "An IPv4 packet was received by/for this node, "
                     "and it is being forward up the stack",
                     MakeTraceSourceAccessor (&Ipv4L3ProtocolwithFecDecode::m_localDeliverTrace),
                     "ns3::Ipv4L3ProtocolwithFecDecode::SentTracedCallback")
...
Ipv4L3ProtocolwithFecDecode::Ipv4L3ProtocolwithFecDecode()
  : m_fec(0)
{
...
void
Ipv4L3ProtocolwithFecDecode::Insert (Ptr<IpL4Protocol> protocol)
{
...
void
Ipv4L3ProtocolwithFecDecode::Insert (Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
...
void
Ipv4L3ProtocolwithFecDecode::Remove (Ptr<IpL4Protocol> protocol)
{
  NS_LOG_FUNCTION (this << protocol);
...
void
Ipv4L3ProtocolwithFecDecode::Remove (Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
  NS_LOG_FUNCTION (this << protocol << interfaceIndex);
...
Ptr<IpL4Protocol>
Ipv4L3ProtocolwithFecDecode::GetProtocol (int protocolNumber) const
{
...
Ptr<IpL4Protocol>
Ipv4L3ProtocolwithFecDecode::GetProtocol (int protocolNumber, int32_t interfaceIndex) const
{
...
void
Ipv4L3ProtocolwithFecDecode::SetNode (Ptr<Node> node)
{
...
Ptr<Socket> 
Ipv4L3ProtocolwithFecDecode::CreateRawSocket (void)
{
  NS_LOG_FUNCTION (this);
...
void 
Ipv4L3ProtocolwithFecDecode::DeleteRawSocket (Ptr<Socket> socket)
{
 ...
 */
void
Ipv4L3ProtocolwithFecDecode::NotifyNewAggregate ()
{
  NS_LOG_FUNCTION (this);
  if (m_node == 0)
    {
...
void 
Ipv4L3ProtocolwithFecDecode::SetRoutingProtocol (Ptr<Ipv4RoutingProtocol> routingProtocol)
{
...
Ipv4L3ProtocolwithFecDecode::GetRoutingProtocol (void) const
{
  NS_LOG_FUNCTION (this);
...
void 
Ipv4L3ProtocolwithFecDecode::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolwithFecDecode::SetupLoopback (void)
{
  NS_LOG_FUNCTION (this);
  ...
  node->RegisterProtocolHandler (MakeCallback (&Ipv4L3ProtocolwithFecDecode::Receive, this), 
                                 Ipv4L3ProtocolwithFecDecode::PROT_NUMBER, device);
  interface->SetUp ();
...
void 
Ipv4L3ProtocolwithFecDecode::SetDefaultTtl (uint8_t ttl)
{
...
uint32_t 
Ipv4L3ProtocolwithFecDecode::AddInterface (Ptr<NetDevice> device)
{
  ...
  tc->RegisterProtocolHandler (MakeCallback (&Ipv4L3ProtocolwithFecDecode::Receive, this),
                               Ipv4L3ProtocolwithFecDecode::PROT_NUMBER, device);
...
uint32_t 
Ipv4L3ProtocolwithFecDecode::AddIpv4Interface (Ptr<Ipv4Interface>interface)
{
...
Ptr<Ipv4Interface>
Ipv4L3ProtocolwithFecDecode::GetInterface (uint32_t index) const
{
...
uint32_t 
Ipv4L3ProtocolwithFecDecode::GetNInterfaces (void) const
{
  NS_LOG_FUNCTION (this);
...
int32_t 
Ipv4L3ProtocolwithFecDecode::GetInterfaceForAddress (
...
int32_t 
Ipv4L3ProtocolwithFecDecode::GetInterfaceForPrefix (
  Ipv4Address address, 
  Ipv4Mask mask) const
{
...
int32_t 
Ipv4L3ProtocolwithFecDecode::GetInterfaceForDevice (
...
bool
Ipv4L3ProtocolwithFecDecode::IsDestinationAddress (Ipv4Address address, uint32_t iif) const
{
...
void 
Ipv4L3ProtocolwithFecDecode::Receive ( Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol, const Address &from,
                          const Address &to, NetDevice::PacketType packetType)
{
  ...
  if (!m_routingProtocol->RouteInput (packet, ipHeader, device,
                                      MakeCallback (&Ipv4L3ProtocolwithFecDecode::IpForward, this),
                                      MakeCallback (&Ipv4L3ProtocolwithFecDecode::IpMulticastForward, this),
                                      MakeCallback (&Ipv4L3ProtocolwithFecDecode::LocalDeliver, this),
                                      MakeCallback (&Ipv4L3ProtocolwithFecDecode::RouteInputError, this)
                                      ))
    {
...
Ipv4L3ProtocolwithFecDecode::GetIcmp (void) const
{
  NS_LOG_FUNCTION (this);
...
bool
Ipv4L3ProtocolwithFecDecode::IsUnicast (Ipv4Address ad) const
{
...
bool
Ipv4L3ProtocolwithFecDecode::IsUnicast (Ipv4Address ad, Ipv4Mask interfaceMask) const
{
...
void 
Ipv4L3ProtocolwithFecDecode::SendWithHeader (Ptr<Packet> packet, 
                                Ipv4Header ipHeader,
                                Ptr<Ipv4Route> route)
{
...
void
Ipv4L3ProtocolwithFecDecode::CallTxTrace (const Ipv4Header & ipHeader, Ptr<Packet> packet,
...
void 
Ipv4L3ProtocolwithFecDecode::Send (Ptr<Packet> packet, 
                      Ipv4Address source,
                      ...
                      Ptr<Ipv4Route> route)
{
      ...
      if (!route->GetGateway ().IsInitialized ())
        {
          ...
          // to be queried).
          NS_FATAL_ERROR ("Ipv4L3ProtocolwithFecDecode::Send case 1a: packet passed with a route but the Gateway address is uninitialized. This case not yet implemented.");
        }

      // 1b) with a valid gateway
      NS_LOG_LOGIC ("Ipv4L3ProtocolwithFecDecode::Send case 1b:  passed in with route and valid gateway");
  ...
  if (destination.IsBroadcast () || destination.IsLocalMulticast ())
    {
      NS_LOG_LOGIC ("Ipv4L3ProtocolwithFecDecode::Send case 2:  limited broadcast - no route");
      ...
      for (uint32_t j = 0; j < GetNAddresses (ifaceIndex); j++)
        {
          ...
          if (destination.IsSubnetDirectedBroadcast (ifAddr.GetMask ()) && 
            ...
            {
              NS_LOG_LOGIC ("Ipv4L3ProtocolwithFecDecode::Send case 3:  subnet directed bcast to " << ifAddr.GetLocal () << " - no route");
              // create a proxy route for this interface
              Ptr<Ipv4Route> route = Create<Ipv4Route> ();
              route->SetDestination (destination);
              route->SetGateway (Ipv4Address::GetAny ());
  ...
  NS_LOG_LOGIC ("Ipv4L3ProtocolwithFecDecode::Send case 4:  not broadcast and passed in with no route " << destination);
  ...
  if (m_routingProtocol != 0)
    ...
    {
      NS_LOG_ERROR ("Ipv4L3ProtocolwithFecDecode::Send: m_routingProtocol == 0");
    }
  if (newRoute)
    {
      DecreaseIdentification (source, destination, protocol);
...
void
Ipv4L3ProtocolwithFecDecode::DecreaseIdentification (Ipv4Address source,
                                        Ipv4Address destination,
                                        uint8_t protocol)
{
...
Ipv4Header
Ipv4L3ProtocolwithFecDecode::BuildHeader (
  Ipv4Address source,
  Ipv4Address destination,
  uint8_t protocol,
...
void
Ipv4L3ProtocolwithFecDecode::SendRealOut (Ptr<Ipv4Route> route,
                             Ptr<Packet> packet,
...
void
Ipv4L3ProtocolwithFecDecode::IpMulticastForward (Ptr<Ipv4MulticastRoute> mrtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
...
void
Ipv4L3ProtocolwithFecDecode::IpForward (Ptr<Ipv4Route> rtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
  ...
  if (m_fec && packet->GetSize () > m_fec->GetSegmentSize ()
      && m_fec->GetFwin () > 0) 
    { 
      FecTag tag;
      ...
      if (rid_ < rid) 
        {
         while (m_fec->TransitQueueSize () > 0)
           {
             Free ();
           }
          rid_ = rid;
      ...
      uint32_t flag =  m_fec->Recv (packet, ipHeader);

      while (m_fec->LostPacketQueueSize () > 0)
        {
          SendRxRequest ();
        }
...
void
Ipv4L3ProtocolwithFecDecode::SendRxRequest ()
{
  NS_LOG_FUNCTION (this);

  Ptr<Packet> pkt = m_fec->GetLostPacket ();
  ...
  rtentry->SetDestination (ipHeader.GetDestination ());
  rtentry->SetGateway (Ipv4Address::GetAny ());
  rtentry->SetOutputDevice (GetNetDevice (1));
  
  Transmit (rtentry, pkt, ipHeader);
} 
void
Ipv4L3ProtocolwithFecDecode::Free ()
{
  NS_LOG_FUNCTION (this);

  Ptr<Packet> pkt = m_fec->GetPacket ();                        
  Ipv4Header ipHeader;
  pkt->RemoveHeader (ipHeader);
  ...
  Ptr<NetDevice> oif (0); // unused for now
  Ptr<Ipv4Route> newRoute;
  newRoute = m_routingProtocol->RouteOutput (pkt, ipHeader, oif, errno_);

  Transmit (newRoute, pkt, ipHeader);
} 

void
Ipv4L3ProtocolwithFecDecode::Transmit (Ptr<Ipv4Route> rtentry, Ptr<Packet> packet, Ipv4Header header)
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolwithFecDecode::LocalDeliver (Ptr<const Packet> packet, Ipv4Header const&ip, uint32_t iif)
{
...
bool
Ipv4L3ProtocolwithFecDecode::AddAddress (uint32_t i, Ipv4InterfaceAddress address)
{
...
Ipv4L3ProtocolwithFecDecode::GetAddress (uint32_t interfaceIndex, uint32_t addressIndex) const
{
...
uint32_t 
Ipv4L3ProtocolwithFecDecode::GetNAddresses (uint32_t interface) const
{
  NS_LOG_FUNCTION (this << interface);
...
bool
Ipv4L3ProtocolwithFecDecode::RemoveAddress (uint32_t i, uint32_t addressIndex)
{
...
bool
Ipv4L3ProtocolwithFecDecode::RemoveAddress (uint32_t i, Ipv4Address address)
{
  NS_LOG_FUNCTION (this << i << address);
...
Ipv4Address
Ipv4L3ProtocolwithFecDecode::SourceAddressSelection (uint32_t interfaceIdx, Ipv4Address dest)
{
...
Ipv4Address 
Ipv4L3ProtocolwithFecDecode::SelectSourceAddress (Ptr<const NetDevice> device,
...
void 
Ipv4L3ProtocolwithFecDecode::SetMetric (uint32_t i, uint16_t metric)
{
...
uint16_t
Ipv4L3ProtocolwithFecDecode::GetMetric (uint32_t i) const
{
...
uint16_t 
Ipv4L3ProtocolwithFecDecode::GetMtu (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
bool 
Ipv4L3ProtocolwithFecDecode::IsUp (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolwithFecDecode::SetUp (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolwithFecDecode::SetDown (uint32_t ifaceIndex)
{
...
bool 
Ipv4L3ProtocolwithFecDecode::IsForwarding (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
Ipv4L3ProtocolwithFecDecode::SetForwarding (uint32_t i, bool val)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
Ptr<NetDevice>
Ipv4L3ProtocolwithFecDecode::GetNetDevice (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
...
void 
Ipv4L3ProtocolwithFecDecode::SetIpForward (bool forward) 
{
...
bool 
Ipv4L3ProtocolwithFecDecode::GetIpForward (void) const
{
  NS_LOG_FUNCTION (this);
  return m_ipForward;
}
...
void 
Ipv4L3ProtocolwithFecDecode::SetWeakEsModel (bool model)
{
...
bool 
Ipv4L3ProtocolwithFecDecode::GetWeakEsModel (void) const
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolwithFecDecode::RouteInputError (Ptr<const Packet> p, const Ipv4Header & ipHeader, Socket::SocketErrno sockErrno)
{
...
void
Ipv4L3ProtocolwithFecDecode::DoFragmentation (Ptr<Packet> packet, const Ipv4Header & ipv4Header, uint32_t outIfaceMtu, std::list<Ipv4PayloadHeaderPair>& listFragments)
{
...
bool
Ipv4L3ProtocolwithFecDecode::ProcessFragment (Ptr<Packet>& packet, Ipv4Header& ipHeader, uint32_t iif)
{
...
Ipv4L3ProtocolwithFecDecode::Fragments::Fragments ()
  : m_moreFragment (0)
{
  NS_LOG_FUNCTION (this);
}
...
void
Ipv4L3ProtocolwithFecDecode::Fragments::AddFragment (Ptr<Packet> fragment, uint16_t fragmentOffset, bool moreFragment)
{
...
bool
Ipv4L3ProtocolwithFecDecode::Fragments::IsEntire () const
{
  NS_LOG_FUNCTION (this);
...
Ptr<Packet>
Ipv4L3ProtocolwithFecDecode::Fragments::GetPacket () const
{
  NS_LOG_FUNCTION (this);
...
Ptr<Packet>
Ipv4L3ProtocolwithFecDecode::Fragments::GetPartialPacket () const
{
  NS_LOG_FUNCTION (this);
...
void
Ipv4L3ProtocolwithFecDecode::Fragments::SetTimeoutIter (FragmentsTimeoutsListI_t iter)
{
  m_timeoutIter = iter;
  return;
}

Ipv4L3ProtocolwithFecDecode::FragmentsTimeoutsListI_t
Ipv4L3ProtocolwithFecDecode::Fragments::GetTimeoutIter ()
{
...
void
Ipv4L3ProtocolwithFecDecode::HandleFragmentsTimeout (FragmentKey_t key, Ipv4Header & ipHeader, uint32_t iif)
{
...
bool
Ipv4L3ProtocolwithFecDecode::UpdateDuplicate (Ptr<const Packet> p, const Ipv4Header &header)
{
  ...
  if (!m_cleanDpd.IsRunning () && m_purge.IsStrictlyPositive ())
    {
      m_cleanDpd = Simulator::Schedule (m_expire, &Ipv4L3ProtocolwithFecDecode::RemoveDuplicates, this);
    }
...
void
Ipv4L3ProtocolwithFecDecode::RemoveDuplicates (void)
{
  NS_LOG_FUNCTION (this);
  ...
  if (!m_dups.empty () && m_purge.IsStrictlyPositive ())
    {
      m_cleanDpd = Simulator::Schedule (m_purge, &Ipv4L3ProtocolwithFecDecode::RemoveDuplicates, this);
    }
}

Ipv4L3ProtocolwithFecDecode::FragmentsTimeoutsListI_t
Ipv4L3ProtocolwithFecDecode::SetTimeout (FragmentKey_t key, Ipv4Header ipHeader, uint32_t iif)
{
  Time now = Simulator::Now () + m_fragmentExpirationTimeout;

  if (m_timeoutEventList.empty ())
    {
      m_timeoutEvent = Simulator::Schedule (m_fragmentExpirationTimeout, &Ipv4L3ProtocolwithFecDecode::HandleTimeout, this);
    }
  m_timeoutEventList.emplace_back (now, key, ipHeader, iif);

  Ipv4L3ProtocolwithFecDecode::FragmentsTimeoutsListI_t iter = --m_timeoutEventList.end();

  return (iter);
}

void
Ipv4L3ProtocolwithFecDecode::HandleTimeout (void)
{
  ...
  m_timeoutEvent = Simulator::Schedule (difference, &Ipv4L3ProtocolwithFecDecode::HandleTimeout, this);

  return;
}

void
Ipv4L3ProtocolwithFecDecode::SetFec (Ptr<FecRouterAgent> fec)
{
  NS_LOG_FUNCTION (this);
  m_fec = fec;
}
