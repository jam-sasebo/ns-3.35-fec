...
int main (int argc, char *argv[])
{
  ...
  */
  ...
  corebandStream << corebandvalue << "Mbps";   //nFlows*corebandvalue　に変更
...
/*  R1_R2p2p.SetDeviceAttribute ("DataRate", StringValue (coreband)); below is R1_R2 bw  */     
 ...
 FecAgent::EnableTcpDump (ascii.CreateFileStream ("TcpRouter.TcpDump"));
 FecAgent::EnablePrintTimeout (ascii.CreateFileStream ("TcpRouter.Timeout"));
 FecAgent::EnablePrintFastRecovery (ascii.CreateFileStream ("TcpRouter.FastRecovery"));
 FecAgent::EnablePrintRetransmit (ascii.CreateFileStream ("TcpRouter.Retransmit"));
 FecAgent::EnablePrintRateControl (ascii.CreateFileStream ("TcpRouter.RateControl"));
...
// FecAgent::EnablePrintGroupFecTable (ascii.CreateFileStream ("FecEnd.GroupFecTable"));
 FecAgent::EnablePrintLostPacket (ascii.CreateFileStream ("TcpRouter.LostPacket"));
 FecAgent::EnablePrintRecovery (ascii.CreateFileStream ("TcpRouter.Recovery"));
 //FecAgent::EnablePrintSentPacket (ascii.CreateFileStream ("TcpRouter3.SentPacket"));  //forgot to add this
///*
 char str[100];
