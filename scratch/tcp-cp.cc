...
int main (int argc, char *argv[])
{
 ...
 FecAgent::EnableTcpDump (ascii.CreateFileStream ("Tcpcp.TcpDump"));
 FecAgent::EnablePrintTimeout (ascii.CreateFileStream ("Tcpcp.Timeout"));
 FecAgent::EnablePrintFastRecovery (ascii.CreateFileStream ("Tcpcp.FastRecovery"));
 FecAgent::EnablePrintRetransmit (ascii.CreateFileStream ("Tcpcp.Retransmit"));
 FecAgent::EnablePrintRateControl (ascii.CreateFileStream ("Tcpcp.RateControl"));
...
// FecAgent::EnablePrintGroupFecTable (ascii.CreateFileStream ("FecEnd.GroupFecTable"));
 FecAgent::EnablePrintLostPacket (ascii.CreateFileStream ("Tcpcp.LostPacket"));
 FecAgent::EnablePrintRecovery (ascii.CreateFileStream ("Tcpcp.Recovery"));
///*
 char str[100];
 char str1[]="cwnd-tcpcp";
 char str3[]=".dat";
