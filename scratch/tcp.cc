...
int main (int argc, char *argv[])
{
 ...
 FecAgent::EnableTcpDump (ascii.CreateFileStream ("Tcp.TcpDump"));
 FecAgent::EnablePrintTimeout (ascii.CreateFileStream ("Tcp.Timeout"));
 FecAgent::EnablePrintFastRecovery (ascii.CreateFileStream ("Tcp.FastRecovery"));
 FecAgent::EnablePrintRetransmit (ascii.CreateFileStream ("Tcp.Retransmit"));
 FecAgent::EnablePrintRateControl (ascii.CreateFileStream ("Tcp.RateControl"));
...
// FecAgent::EnablePrintGroupFecTable (ascii.CreateFileStream ("FecEnd.GroupFecTable"));
 FecAgent::EnablePrintLostPacket (ascii.CreateFileStream ("Tcp.LostPacket"));
 FecAgent::EnablePrintRecovery (ascii.CreateFileStream ("Tcp.Recovery"));
///*
 char str[100];
 char str1[]="cwnd";
 char str3[]=".dat";
