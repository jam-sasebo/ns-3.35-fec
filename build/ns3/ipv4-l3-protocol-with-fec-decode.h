...
#ifndef IPV4_L3_PROTOCOL_WITH_FEC_DECODE_H
#define IPV4_L3_PROTOCOL_WITH_FEC_DECODE_H
 ...
 * attack.
 */
class Ipv4L3ProtocolwithFecDecode : public Ipv4
{
public:
  /**
  ...
  Ipv4L3ProtocolwithFecDecode();
  virtual ~Ipv4L3ProtocolwithFecDecode ();
...
private:
  /**
   * \brief Ipv4L3ProtocolwithFecDecodeTestCase test case.
   * \relates Ipv4L3ProtocolwithFecDecodeTestCase
   */
   ...
   */
  Ipv4L3ProtocolwithFecDecode(const Ipv4L3ProtocolwithFecDecode &);
   ...
   */
  Ipv4L3ProtocolwithFecDecode &operator = (const Ipv4L3ProtocolwithFecDecode &);
  ...
  void 
  Transmit (Ptr<Ipv4Route> rtentry, 
            Ptr<Packet> p, 
            Ipv4Header header);
...
#endif /* IPV4_L3_PROTOCOL_WITH_FEC_DECODE_H */
