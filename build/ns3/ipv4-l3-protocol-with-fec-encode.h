...
#ifndef IPV4_L3_PROTOCOL_WITH_FEC_ENCODE_H
#define IPV4_L3_PROTOCOL_WITH_FEC_ENCODE_H
 ...
 * attack.
 */
class Ipv4L3ProtocolwithFecEncode : public Ipv4
{
public:
  /**
  ...
  Ipv4L3ProtocolwithFecEncode();
  virtual ~Ipv4L3ProtocolwithFecEncode ();
  ...
  void RedundancyControl ();
  void SendFecPacket (Ptr<Packet> packet, Ipv4Header const &ipHeader, Ptr<Ipv4Interface> outInterface);
...
private:
  /**
   * \brief Ipv4L3ProtocolwithFecEncodeTestCase test case.
   * \relates Ipv4L3ProtocolwithFecEncodeTestCase
   */
   ...
   */
  Ipv4L3ProtocolwithFecEncode(const Ipv4L3ProtocolwithFecEncode &);
   ...
   */
  Ipv4L3ProtocolwithFecEncode &operator = (const Ipv4L3ProtocolwithFecEncode &);
...
#endif /* IPV4_L3_PROTOCOL_WITH_FEC_ENCODE_H */
